...
## 1. Purpose
The `GeminiDriver` is the central brain of Arnold. It manages the continuous tool-use loop, maintains the task state, handles model orchestration (routing between Pro, Flash, and Ollama), and enforces the verification protocol.

## 2. Logic Mapping & Porting Plan

| LocalClaw Module | Method/Logic | Arnold Implementation | Notes |
| :--- | :--- | :--- | :--- |
...
| `orchestrator.js` | `Hooks/Loggers` | `ArnoldHooks` | Streamlined logging |
